...
public class DepartTimeFilterTests {
    ...
    @Test
    public void testFilterSegments_DepartTimeIsBefore() {
        List<Flight> actual = filterQueryBuilder.select(flights)
                .filterSegments(new DepartureTimeFilter().isBefore(threeDaysFromNow.minusHours(1))).get();
    ...
    @Test
    public void testFilterSegments_DepartTimeIsAfter() {
        List<Flight> actual = filterQueryBuilder.select(flights)
                .filterSegments(new DepartureTimeFilter().isAfter(threeDaysFromNow.plusHours(2))).get();
    ...
    @Test
    public void testFilterSegments_DepartTimeEquals() {
        List<Flight> actual = filterQueryBuilder.select(flights)
                .filterSegments(new DepartureTimeFilter().isEqual(threeDaysFromNow.plusHours(3))).get();
